...
export default function AdminSubmissionsOverviewPage() {
  const { token } = useAuth();
  ...
  return (
    <div className="flex flex-col h-full">
      <AdminTopbar
        ...
        subtitle="Select a form to view and manage its submissions"
      />
        ...
        {isLoading ? (
          ...
          <div className="neo-card text-center py-16">
            ...
            <p className="text-muted-foreground text-sm mt-1 mb-6">
              Create a form first to start collecting submissions.
            </p>
